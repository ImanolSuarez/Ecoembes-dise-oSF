...
public class LoginController {
    ...
    public ResponseEntity<String> validateToken(
            @Parameter(name = "token", description = "Token a validar", required = true) @RequestParam("token") String token) {
    ...
    public ResponseEntity<String> getSessionInfo(
            @Parameter(name = "token", description = "Token de sesión", required = true) @RequestParam("token") String token) {
