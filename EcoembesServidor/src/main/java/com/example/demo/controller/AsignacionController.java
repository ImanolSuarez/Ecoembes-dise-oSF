...
public class AsignacionController {
    ...
    @Operation(
            summary = "Obtener asignaciones por empleado",
            responses = {@ApiResponse(responseCode = "200", description = "Lista obtenida")}
    )
    @GetMapping("/empleado/{email}")
    public ResponseEntity<List<AsignacionDTO>> getByEmpleado(@PathVariable String email) {
    ...
    @Operation(
            summary = "Obtener asignaciones por planta",
            responses = {@ApiResponse(responseCode = "200", description = "Lista obtenida")}
    )
    @GetMapping("/planta/{plantaId}")
    public ResponseEntity<List<AsignacionDTO>> getByPlanta(@PathVariable Long plantaId) {
    ...
    @Operation(
            summary = "Obtener asignaciones por fecha",
            responses = {@ApiResponse(responseCode = "200", description = "Lista obtenida")}
    )
