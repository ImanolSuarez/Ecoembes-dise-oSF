...
public class EcoembesFacade {
    ...
    public List<Contenedor> getContenedoresByNivelYFecha(Contenedor.NivelLlenado nivel, LocalDateTime inicio, LocalDateTime fin) {
        return contenedorService.findByNivelYFecha(nivel, inicio, fin);
    }

    public List<Contenedor> getContenedoresByNivelUbicacionYFecha(Contenedor.NivelLlenado nivel, String ubicacion, LocalDateTime inicio, LocalDateTime fin) {
